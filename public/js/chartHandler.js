...
const getOptions = async () => {
    ...
    document.getElementById('group-options-'+groupOption).setAttribute("checked", "checked");
    timeOption = chartOption.time_options;
    document.getElementById('time-options-'+timeOption).setAttribute("checked", "checked");
}
...
const renderChart = async (chartNumber) => {
